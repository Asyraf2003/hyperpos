...
final class TransactionPaymentStatusLabelResolverTest extends TestCase
{
    public function test_it_resolves_indonesian_payment_status_labels(): void
    {
        ...
        $this->assertSame('Ada Pengembalian Dana', $resolver->resolve(100000, 100000, 20000));
        $this->assertSame('Pengembalian Dana Penuh', $resolver->resolve(100000, 100000, 100000));
    }
}
