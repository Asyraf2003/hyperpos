...
final class EditableWorkspaceNoteGuardFeatureTest extends TestCase
{
    ...
    public function test_it_rejects_note_that_already_has_payment_allocation(): void
    {
        DB::table('notes')->insert([
            'id' => 'note-1',
            'customer_name' => 'Budi',
        ...
        $this->expectExceptionMessage('Nota yang sudah memiliki pembayaran tidak boleh diedit lewat workspace.');
