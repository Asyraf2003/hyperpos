...
- `refunded_product_component_rupiah` sums `product_only_work_item` and `service_store_stock_part`.
...
- Final closure: `make verify` GREEN by operator confirmation after testing DB reset.
