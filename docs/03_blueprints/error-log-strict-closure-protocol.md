...
This document is the canonical workflow for promoting `docs/error_log/*.md` items from patched-or-better status into strict fixed status.
...
- docs/adr/0016-post-close-note-correction-and-refund-flexibility.md
