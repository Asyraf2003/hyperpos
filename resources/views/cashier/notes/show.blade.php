    ...
    <div class="row g-3">
        <div class="col-md-3">
            <div class="card"><div class="card-body">
                ...
                <div class="fw-bold">{{ $note['customer_name_current'] }}</div>
            </div></div>
        </div>
        ...
        <div class="col-md-3">
            <div class="card"><div class="card-body">
                ...
                <div class="fw-bold">{{ $note['transaction_date'] }}</div>
            </div></div>
        </div>
        ...
        <div class="col-md-3">
            <div class="card"><div class="card-body">
                ...
                <div class="fw-bold text-uppercase">{{ $note['payment_status'] }}</div>
            </div></div>
        </div>
        ...
        <div class="col-md-3">
            <div class="card"><div class="card-body">
                ...
                <div class="fw-bold">{{ number_format($note['outstanding_rupiah'], 0, ',', '.') }}</div>
            </div></div>
        </div>
    </div>
