        ...
        <div class="modal-content">
            <div class="modal-header">
                <div>
                    ...
                    <p class="mb-0 text-muted small">Fokuskan keputusan bayar di sini, bukan di panel samping.</p>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" id="inline_payment_amount_paid_rupiah" name="inline_payment[amount_paid_rupiah]" value="{{ $oldInlinePayment['amount_paid_rupiah'] }}" class="form-control" inputmode="numeric" placeholder="Isi untuk bayar sebagian">
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" id="inline_payment_amount_received_rupiah" name="inline_payment[amount_received_rupiah]" value="{{ $oldInlinePayment['amount_received_rupiah'] }}" class="form-control" inputmode="numeric" placeholder="Wajib untuk cash">
                        </div>
                    </div>
                </div>

                <div class="border rounded p-3">
                    <div class="small text-muted mb-1">Ringkasan Cepat</div>
                    <div class="fw-semibold" id="workspace-modal-payment-decision-text">Skip</div>
                    <div class="text-muted small" id="workspace-modal-payment-method-text">Belum diatur</div>
                </div>
            </div>
