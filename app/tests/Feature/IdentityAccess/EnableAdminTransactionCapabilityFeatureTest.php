...
final class EnableAdminTransactionCapabilityFeatureTest extends TestCase
{
    ...
    public function test_enable_capability_endpoint_updates_state_and_writes_audit_log(): void
    {
        ...
        $response = $this->postJson('/identity-access/admin-transaction-capability/enable', [
        ...
        $this->assertDatabaseHas('audit_logs', [
            'event' => 'admin_transaction_capability_enabled',
            'context' => json_encode([
                'target_actor_id' => 'admin-1',
                'performed_by_actor_id' => 'owner-1',
