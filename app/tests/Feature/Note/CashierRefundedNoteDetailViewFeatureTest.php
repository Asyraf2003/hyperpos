...
final class CashierRefundedNoteDetailViewFeatureTest extends TestCase
{
    ...
    public function test_refunded_note_detail_shows_refund_panel_and_hides_payment_and_edit_workspace(): void
    {
        $user = $this->seedKasir();
        ...
        $this->actingAs($user)
            ...
            ->assertDontSee('Aksi Workspace')
            ->assertDontSee('Edit Workspace');
    }
    ...
    private function seedKasir(): User
    {
        ...
        $user = User::query()->create([
            'name' => 'Kasir Refunded View',
            'email' => 'cashier-refunded-view@example.test',
            'password' => 'password',
        ]);
