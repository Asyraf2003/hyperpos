...
use App\Application\Reporting\Exports\ServicePackageProfitBreakdownExcelWorkbookBuilder;
...
final class ServicePackageProfitBreakdownReportExcelExportController extends Controller
{
    ...
    public function __invoke(
        ...
        ServicePackageProfitBreakdownExcelWorkbookBuilder $workbookBuilder,
    ): Response {
        ...
        $filename = sprintf(
            'laporan-laba-paket-service-%s-sampai-%s.xlsx',
            $query->fromTransactionDate(),
            $query->toTransactionDate(),
        );
