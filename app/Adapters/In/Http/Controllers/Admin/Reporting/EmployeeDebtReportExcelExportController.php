...
use App\Application\Reporting\Exports\EmployeeDebtReportExcelWorkbookBuilder;
...
final class EmployeeDebtReportExcelExportController extends Controller
{
    ...
    public function __invoke(
        ...
        EmployeeDebtReportExcelWorkbookBuilder $workbookBuilder,
    ): Response {
    ...
    {
        return sprintf(
            'laporan-hutang-karyawan-%s-sampai-%s.xlsx',
            $query->fromRecordedDate(),
            $query->toRecordedDate(),
        );
    }
