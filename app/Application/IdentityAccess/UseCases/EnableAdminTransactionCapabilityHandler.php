...
final class EnableAdminTransactionCapabilityHandler
{
    ...
    public function handle(string $targetActorId, string $performedByActorId): Result
    {
        ...
        $this->capabilities->activate($targetActorId);

        $this->audit->record('admin_transaction_capability_enabled', [
        ...
        return Result::success(
            ...
            'Capability input transaksi admin diaktifkan.'
        );
    }
}
