...
final class TransactionCashLedgerPageQuery
{
    ...
    public function fromEventDate(): string
    {
    ...
    public function toEventDate(): string
    {
    ...
    public function toViewData(): array
    {
        return [
            ...
            'date_from' => $this->fromEventDate(),
            'date_to' => $this->toEventDate(),
            'range_label' => $this->fromEventDate() . ' s/d ' . $this->toEventDate(),
        ];
    }
