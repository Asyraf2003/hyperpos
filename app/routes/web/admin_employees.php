...
use App\Adapters\In\Http\Controllers\Admin\Employee\EmployeePayrollDetailPageController;
...
Route::middleware(['web', 'auth', 'admin.page', 'app.shell'])->group(function (): void {
    ...
    Route::get('/admin/employees/{employeeId}/payrolls', EmployeePayrollDetailPageController::class)->name('admin.employees.payrolls.show');
